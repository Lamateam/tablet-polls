  ...
  grunt.initConfig
    ...
    run_java:
      javac_task:
        command: "javac",
        javaOptions:
          cp: [ "tomcat/lib/servlet-api.jar;tomcat/lib/json-simple-1.1.1.jar;tomcat/lib/javax.faces-api-2.2.jar;tomcat/lib/javax.servlet-api-3.1.0;tomcat/lib/commons-fileupload-1.3;tomcat/lib/commons-io-2.5" ]
